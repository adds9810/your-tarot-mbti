  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
      <div className="bg-[#1a2320] rounded-lg p-6 w-full max-w-[90%] md:max-w-md relative text-white shadow-lg">
        ...
        <h3 className="text-lg font-semibold mb-4">후기를 남겨주세요</h3>
        ...
        <Textarea
          ...
          className="w-full h-24 p-3 bg-transparent border border-gray-600 rounded resize-none mb-2 text-sm"
        />
        {errorMessage && (
          <p className="text-red-400 text-xs mb-4">{errorMessage}</p>
        )}
        <Button
